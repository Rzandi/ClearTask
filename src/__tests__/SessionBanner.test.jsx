...
describe('SessionBanner', () => {
  // 10.1 Unit test: render mobile "Buka Sesi" banner when session is null
  it('should render "Belum ada sesi" banner when session is null', () => {
    render(<SessionBanner session={null} onClose={vi.fn()} onOpen={vi.fn()} />);
