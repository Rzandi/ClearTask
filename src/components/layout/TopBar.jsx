  ...
  return (
    <header className="flex items-center justify-between gap-4 mb-6 lg:mb-8">
      ...
      <div className="flex items-center gap-3">
        ...
        {/* Settings Icon */}
        <button onClick={onSettingsOpen} className="w-10 h-10 flex items-center justify-center rounded-xl border border-border-default hover:bg-white/[0.04] transition-colors cursor-pointer">
        ...
        <div className="relative" ref={notifRef}>
          <button
            onClick={onNotifOpen}
            className="w-10 h-10 flex items-center justify-center rounded-xl border border-border-default hover:bg-white/[0.04] transition-colors cursor-pointer relative"
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#8b949e" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
